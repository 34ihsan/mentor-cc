                    ...
                    <div className="flex items-center gap-10">
                        <div className="flex gap-4">
                            ...
                            {siteConfig?.social?.linkedin && (
                                <a href={siteConfig.social.linkedin} target="_blank" rel="noopener noreferrer">
                                    <svg className="w-4 h-4 hover:text-[#D4AF37] cursor-pointer transition-colors stroke-[2.5] fill-current" viewBox="0 0 24 24">
                        ...
                        <div className="flex items-center gap-3 border-l border-slate-200 pl-8">
                            ...
                            <Link href={"/iletisim" as any}>
                                <span className="text-slate-600 lowercase text-[13px] font-bold hover:text-[#D4AF37] transition-colors cursor-pointer">{siteConfig?.contact?.email || 'info@mentor-cc.com'}</span>
                            </Link>
                        </div>
                    </div>
